...
local t_event_config=
{
 ...
 {   eventId = 21,   event = "getImage",   inParams = "imgId:int",   outParams = "img:image" }, 
 {   eventId = 22,   event = "getMyPosts",   inParams = "sessionKey:string#lastPostId:int",   outParams = "postList:SeqPost" }, 
